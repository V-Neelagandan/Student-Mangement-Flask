...
@values.route("/submitform", methods=['GET', 'POST'])
def add_data():
...
@values.route("/edit/<int:id>", methods=['GET', 'POST'])
def edit_data(id):
    if request.method == "POST":
        updated_data = {
